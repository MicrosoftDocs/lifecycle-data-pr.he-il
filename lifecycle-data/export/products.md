...
ms.locfileid: "885185"
---
# <a name="export"></a><span data-ttu-id="0e319-103">ייצוא</span><span class="sxs-lookup"><span data-stu-id="0e319-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="0e319-104">דף זה נמצא תחת פיתוח.</span><span class="sxs-lookup"><span data-stu-id="0e319-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="0e319-105">ייצוא כל המוצרים</span><span class="sxs-lookup"><span data-stu-id="0e319-105">Export All Products</span></span>
<span data-ttu-id="0e319-106">יצא את כל המוצרים ללא מסננים.</span><span class="sxs-lookup"><span data-stu-id="0e319-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="0e319-107">ייצוא כל המוצרים</span><span class="sxs-lookup"><span data-stu-id="0e319-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="0e319-108">ייצוא מוצרים לפי קטגוריה</span><span class="sxs-lookup"><span data-stu-id="0e319-108">Export Products by Category</span></span>
<span data-ttu-id="0e319-109">בחר קבוצה לייצוא:</span><span class="sxs-lookup"><span data-stu-id="0e319-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="0e319-167">ייצוא מוצרים לפי סוף שנת התמיכה</span><span class="sxs-lookup"><span data-stu-id="0e319-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="0e319-168">בחר שנה כדי לייצא את שירות הסיום של products באותה שנה:</span><span class="sxs-lookup"><span data-stu-id="0e319-168">Select a year to export products ending service in that year:</span></span>
