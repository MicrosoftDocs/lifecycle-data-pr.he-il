...
ms.locfileid: "940852"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="1ce7d-103">ייצוא נתוני מחזור חיים</span><span class="sxs-lookup"><span data-stu-id="1ce7d-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="1ce7d-104">דף זה נמצא תחת פיתוח.</span><span class="sxs-lookup"><span data-stu-id="1ce7d-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="1ce7d-105">ייצוא כל המוצרים</span><span class="sxs-lookup"><span data-stu-id="1ce7d-105">Export all products</span></span>
<span data-ttu-id="1ce7d-106">ייצוא נתוני מחזור חיים עבור כל המוצרים על-ידי לחיצה להלן:</span><span class="sxs-lookup"><span data-stu-id="1ce7d-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="1ce7d-107">ייצוא כל המוצרים</span><span class="sxs-lookup"><span data-stu-id="1ce7d-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="1ce7d-108">ייצוא מוצרים לפי משפחה וקבוצה</span><span class="sxs-lookup"><span data-stu-id="1ce7d-108">Export products by Family and Group</span></span>
<span data-ttu-id="1ce7d-109">בחר משפחה ולאחר מכן בחר קבוצה לייצוא.</span><span class="sxs-lookup"><span data-stu-id="1ce7d-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="1ce7d-110">הערה: הייצוא יחל בעת בחירת ערך קבוצה.</span><span class="sxs-lookup"><span data-stu-id="1ce7d-110">Note: Export will begin when Group value is selected.</span></span> 
...
> - [(Microsoft 365 | ניידות ארגונית + אבטחה)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20365'%20and%20parent/parent/name%20eq%20'Enterprise%20Mobility%20%2B%20Security')
...
> - [(Microsoft Edge | כל](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Edge')
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="1ce7d-171">ייצוא מוצרים לפי תאריך סיום התמיכה</span><span class="sxs-lookup"><span data-stu-id="1ce7d-171">Export products by end of support date</span></span>
<span data-ttu-id="1ce7d-172">בחר שנה כדי לראות מוצרים המגיעים לסוף התמיכה.</span><span class="sxs-lookup"><span data-stu-id="1ce7d-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="1ce7d-173">הערה: הייצוא יחל כאשר ערך השנה נבחר.</span><span class="sxs-lookup"><span data-stu-id="1ce7d-173">Note: Export will begin when Year value is selected.</span></span>
